...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/eriklar/Library/Application Support/luaglider2/dev";local SOCKET_PORT=33995;local GLIDER_MAIN_FOLDER= "/Users/eriklar/Documents/superheroes";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
